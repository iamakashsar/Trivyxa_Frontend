...
// Custom CSS for color-changing dot animation
const colorChangingDotStyles = `
  @keyframes colorChange {
    0% { background-color: #ef4444; } /* red-500 */
    20% { background-color: #3b82f6; } /* blue-500 */
    40% { background-color: #10b981; } /* green-500 */
    60% { background-color: #f59e0b; } /* yellow-500 */
    80% { background-color: #8b5cf6; } /* purple-500 */
    100% { background-color: #ef4444; } /* back to red */
  }
...
const navigation = {
  services: [
    ...
    { name: 'Photography', href: '/#features' },
...
export default function Footer() {
  // Inject CSS styles for color-changing dot animation
  React.useEffect(() => {
    const styleElement = document.createElement('style')
    styleElement.textContent = colorChangingDotStyles
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-900 dark:text-white">Services</h3>
          ...
          <div className="mt-10 xl:mt-0">
            <h3 className="text-sm/6 font-semibold text-gray-900 dark:text-white">Contact Us</h3>
            <div className="mt-6 space-y-4">
              <div className="flex items-center">
                ...
                <a href="mailto:trivyxatech@gmail.com" className="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+918530402845" className="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                  +91 8530402845
                </a>
              </div>
            </div>
           ...
           <div className="md:order-1 md:mt-0">
             <p className="mt-8 text-sm/6 text-gray-600 dark:text-gray-400 md:mt-0">
               &copy; 2025 Trivyxa Digital Services. All rights reserved.
             </p>
           </div>
         ...
         <div className="mt-4 flex justify-end">
           <p className="text-sm/6 text-gray-500 dark:text-gray-500 flex items-center">
             Created by{' '}
             <a 
               href="https://www.linkedin.com/company/trivyxa-tech/" 
               target="_blank" 
               rel="noopener noreferrer"
               className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors duration-200 ml-1"
             >
               Trivyxa Tech
             </a>
             <span className="ml-2 w-1.5 h-1.5 rounded-full color-changing-dot"></span>
           </p>
         </div>
      </div>
    </footer>
